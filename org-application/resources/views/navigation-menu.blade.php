<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 sticky top-0 w-full z-50">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @elseif (Auth::user()->role === "Applicant")
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link href="{{ route('reporting', ['nickname' => Auth::user()->nickname]) }}" :active="request()->routeIs('reporting')">
                            {{ __('Reporting') }}
                        </x-nav-link>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link href=" {{ route('mdi', ['nickname' => Auth::user()->nickname]) }} " :active="request()->routeIs('mdi')">
